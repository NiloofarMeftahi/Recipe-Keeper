...
from model import Recipes,Users, api , db, cache
...
class RecipeItem(Resource):
    ...
    def get(self, recipe , user=None):
        ...
        body.add_control("self", href = url_for("api.single_recipe", recipe=db_recipe.title, user = None))
        """
        else :
            print("again ")
        ...
        body.add_control("collection", href = url_for("recipes"))
